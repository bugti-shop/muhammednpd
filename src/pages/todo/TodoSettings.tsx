...
const TodoSettings = () => {
  ...
  const handleShareApp = () => {
    if (navigator.share) {
      ...
      toast.error(t('toasts.shareNotAvailable'));
    }
  };
        ...
        <div className="max-w-2xl mx-auto space-y-4">
          ...
          <div className="border border-border rounded-lg overflow-hidden">
            ...
            {Capacitor.isNativePlatform() && (
              <SettingsRow 
                label={t('settings.quickAdd', 'Quick Add')} 
            ...
            {Capacitor.isNativePlatform() && (
              <SettingsRow 
                label={t('settings.widgets', 'Home Screen Widgets')} 
                onClick={() => setShowWidgetSettingsSheet(true)} 
              />
            )}
          </div>
