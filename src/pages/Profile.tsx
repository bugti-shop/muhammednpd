...
import { ArrowLeft, HardDrive, User, LogOut, Cloud, CloudOff, Loader2 } from 'lucide-react';
  ...
  const handleSignIn = async () => {
    try {
      ...
      toast({
        ...
        description: 'Your Google account is connected for Drive sync.',
      });
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-muted/30 pb-20">
      ...
      <div className="flex flex-col items-center px-6 pt-12">
        <div className="flex flex-col items-center w-full max-w-sm">
          ...
          {user && (
            <p className="text-sm text-muted-foreground mb-2 text-center">{user.email}</p>
          )}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-foreground">
                        {t('profile.driveConnected', 'Google Drive Connected')}
                      </p>
                      <p className="text-xs text-muted-foreground truncate">
                        {t('profile.syncReady', 'Ready to sync your data')}
                      </p>
                    </div>
                  </div>
                </div>
