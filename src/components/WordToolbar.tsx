...
// Initialize visibility from stored settings
const initToolbarVisibility = async () => {
  try {
    const stored = localStorage.getItem('settings_wordToolbarVisibility');
    if (stored) {
...
export const WordToolbar = ({
  ...
  // Listen for visibility changes from ToolbarOrderManager
  useEffect(() => {
  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center gap-0 px-1 overflow-x-auto scrollbar-hide h-12">
        ...
        {(isToolbarItemVisible('undo') || isToolbarItemVisible('redo')) && <Sep />}
        ...
        {(isToolbarItemVisible('fontSize') || isToolbarItemVisible('fontFamily')) && <Sep />}
        ...
        {(isToolbarItemVisible('bold') || isToolbarItemVisible('italic') || isToolbarItemVisible('underline') || isToolbarItemVisible('strikethrough')) && <Sep />}
        ...
        {(isToolbarItemVisible('textColor') || isToolbarItemVisible('highlight')) && <Sep />}
        ...
        {(isToolbarItemVisible('bulletList') || isToolbarItemVisible('numberedList')) && <Sep />}
        ...
        {(isToolbarItemVisible('alignLeft') || isToolbarItemVisible('alignCenter') || isToolbarItemVisible('alignRight') || isToolbarItemVisible('alignJustify')) && <Sep />}
        ...
        {(isToolbarItemVisible('table') || isToolbarItemVisible('image') || isToolbarItemVisible('horizontalRule')) && <Sep />}
        ...
        {(isToolbarItemVisible('subscript') || isToolbarItemVisible('superscript') || isToolbarItemVisible('clearFormatting') || isToolbarItemVisible('headings')) && <Sep />}
        ...
        {(isToolbarItemVisible('link') || isToolbarItemVisible('noteLink') || isToolbarItemVisible('attachment') || isToolbarItemVisible('emoji')) && <Sep />}
